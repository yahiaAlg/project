<?php $this->partial('_header', ['pageTitle' => 'Add New Book']); ?>
        ...
        <form action="/books" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control" required
                               value="<?= isset($book['title']) ? e($book['title']) : '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="author" name="author" class="form-control" required
                               value="<?= isset($book['author']) ? e($book['author']) : '' ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="isbn" name="isbn" class="form-control" required
                                       value="<?= isset($book['isbn']) ? e($book['isbn']) : '' ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="published_year" name="published_year" class="form-control" required
                                       min="1000" max="<?= date('Y') ?>"
                                       value="<?= isset($book['published_year']) ? e($book['published_year']) : '' ?>">
                                ...
                                <select id="category" name="category" class="form-select" required>
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?= e($category) ?>" 
                                            <?= isset($book['category']) && $book['category'] === $category ? 'selected' : '' ?>>
                                            <?= e($category) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="total_copies" name="total_copies" class="form-control" required
                                       min="1" value="<?= isset($book['total_copies']) ? e($book['total_copies']) : '1' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="shelf_location" name="shelf_location" class="form-control"
                               value="<?= isset($book['shelf_location']) ? e($book['shelf_location']) : '' ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="description" class="form-label">Description</label>
                        <textarea id="description" name="description" class="form-control" rows="4"><?= isset($book['description']) ? e($book['description']) : '' ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mt-3">
                        <img src="/assets/images/placeholder-cover.jpg" alt="Book cover preview" class="img-fluid rounded" id="cover-preview">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="/books" class="btn btn-outline-primary ml-2">Cancel</a>
            </div>
        </form>
    </div>
</div>
